    ...
    <div className="pb-16 pt-20 text-center lg:pt-32 animate-in-slide-top">
      <h1 className="mx-auto max-w-4xl font-display text-5xl font-medium tracking-tight dark:text-white/80 text-slate-900/80 sm:text-7xl">
        ...
        <span className="relative whitespace-nowrap text-primary">
          ...
          <span className="relative">accessibility</span>
        </span>{" "}
        through puppy love.
      </h1>
      <p className="mx-auto mt-6 max-w-2xl text-lg tracking-tight dark:text-white/80 text-slate-700/70">
        {`Our EEG-powered robotics provides therapy and essential services to
        those with neurological disorders who need but can't care for a live
        animal`}
      </p>
